...
#define BLOW_DUST 60*1000  // 空吹30秒
#define PRE_FEED 70*1000  //  预送料时间90秒
#define FIRE_UNTIL_FEED 240*1000  // 加热棒工作，4分后开始送料
#define DELAY_RUNNING 120*1000  // 延迟进入运行状态，60秒后开始判断
...
// 冷却温度
#define TEMP_COOLING 65
#define FLAME_DOWN 60
// 工作温度
#define TEMP_RUN 70  // 70
